"""
Visualize visual annotation clustering results.
"""
...
def visualize_clustering(
    ...
    ax.legend(bbox_to_anchor=(1.0, 0.0), loc='lower right', fontsize=16)
...
def main():
    ...
    output_path = (
        project_root / 'output' / 'clustering' /
        'visual_annotation_clustering_plot.png'
    )

    print("=" * 60)
    print("Visual Annotation Clustering Visualization")
    print("=" * 60)
    print()
